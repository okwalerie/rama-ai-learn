(ns hld-rate-limiter.functional-challenge-test
  "Runs functional private tests against the implementation at 2 and 4 tasks."
  (:require
   [clojure.test :refer [deftest testing]]
   [hld-rate-limiter.functional-test-support :as support]))

(deftest functional-challenge-test-2-tasks
  (testing "RateLimiter functional tests, 2 tasks"
...
(deftest functional-challenge-test-4-tasks
  (testing "RateLimiter functional tests, 4 tasks"
    (support/test-module-functional
